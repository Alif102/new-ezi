...
const Payment = ({isDarkMode}) => {
  return (
    <div>
      ...
      <div className={`px-7 py-6 rounded-lg ${isDarkMode ? 'bg-[#30334e]' : 'bg-white'}`}
      >
    ...
    <div className='my-10 '>
        <h1 className=' font-semibold text-gray-500'>More payment settings</h1>
    ...
    <div className={`my-10 px-7 py-6 rounded-lg ${isDarkMode ? 'bg-[#30334e]' : 'bg-white'}`}
    >
  ...
  className={`px-2 py-1 my-3 ${isDarkMode ? 'bg-[#30334e]' : 'bg-white'} border border-gray-300 rounded-lg`}
...
>
  ADD
    ...
    <div className={`mt-4 mb-5 px-7 py-6 rounded-lg ${isDarkMode ? 'bg-[#30334e]' : 'bg-white'}`}
    >
 ...
 className={`px-2 py-1 my-3 ${isDarkMode ? 'bg-[#30334e]' : 'bg-white'} border border-gray-300 rounded-lg block w-full mt-3 shadow-sm my-element sm:text-sm`}
>
   ...
   {/* right side */}
    ...
    <div className=' lg:col-span-3 col-span-1 '>
       ...
       <div className={`rounded-xl p-5 ${isDarkMode ? 'bg-[#2c2c2c]' : 'bg-[#ebecee]'}`}
       >
        <h1 className=' font-semibold text-gray-500'>Payment capture method</h1>
    ...
    <button
      ...
      >
       ...
       <div className={`rounded-xl p-5 mt-5 ${isDarkMode ? 'bg-[#2c2c2c]' : 'bg-[#ebecee]'}`}>
        <h1 className=' font-semibold text-gray-500'>Custom settings</h1>
